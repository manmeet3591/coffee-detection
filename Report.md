...
- Filtering is now "live"; toggling the Crop or Health filters updates the vector overlays instantly without reloading the base imagery.
...
- **Interactive Statistics Dashboard:** A side-panel or popup displaying a "Health Summary" (e.g., total hectares of healthy vs. stressed cocoa) as the user filters the map.
